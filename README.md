...
1. [Setup - The basics of getting started with gerber](#setup)
    * [What gerber affects](#what-gerber-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with gerber](#beginning-with-gerber)
